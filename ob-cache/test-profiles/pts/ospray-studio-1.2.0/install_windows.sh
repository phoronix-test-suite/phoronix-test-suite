...
unzip -o ospray_studio-0.13.0.x86_64.windows.zip
...
../ospray_studio-0.13.0.x86_64.windows/bin/ospStudio.exe benchmark --denoiser --format jpg \$@ RoomScene.sg > \$LOG_FILE 2>&1
