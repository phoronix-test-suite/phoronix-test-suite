...
echo "#!/bin/bash
[ ! -d \"/Volumes/luxcorerender-v2.5-mac64/\" ] && hdid luxcorerender-v2.5-mac64.dmg

/Volumes/luxcorerender-v2.5-mac64/LuxCore.app/Contents/MacOS/luxcoreconsole \$@ > \$LOG_FILE 2>&1
