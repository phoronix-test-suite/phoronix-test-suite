...
unzip -o luxcorerender-v2.5-win64-sdk.zip
unzip -o DLSC-23.zip
...
cp -f luxcorerender-v2.5-win64-sdk/lib/* luxcorerender-v2.5-win64-sdk/bin

echo "#!/bin/sh
./luxcorerender-v2.5-win64-sdk/bin/luxcoreconsole.exe \$@ > \$LOG_FILE 2>&1
