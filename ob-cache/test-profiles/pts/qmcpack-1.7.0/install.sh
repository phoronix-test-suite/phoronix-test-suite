#!/bin/sh
tar -xf qmcpack-3.17.1.tar.gz
cd qmcpack-3.17.1/build/
ADD_TO_CMAKE=""
...
#!/bin/sh
cd qmcpack-3.17.1/\$1
OMP_NUM_THREADS=1 mpirun --allow-run-as-root -np \$NUM_CPU_PHYSICAL_CORES ~/qmcpack-3.17.1/build/bin/qmcpack \$2 > \$LOG_FILE 2>&1
