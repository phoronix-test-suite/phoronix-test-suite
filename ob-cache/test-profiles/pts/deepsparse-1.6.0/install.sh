#!/bin/sh
rm -rf ~/.cache/
pip3 install --user deepsparse==1.6.0 sparsezoo==1.6.0
...
~/.local/bin/sparsezoo.download zoo:nlp/question_answering/obert-large/pytorch/huggingface/squad/base-none
