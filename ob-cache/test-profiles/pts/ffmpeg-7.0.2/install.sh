...
cat > ffmpeg_/lib/pkgconfig/x265.pc << EOF
prefix=${INSTALL_FOLDER}/ffmpeg_/
exec_prefix=\${prefix}
...
export VBENCH_ROOT=$INSTALL_FOLDER/vbench/
python3 reference.py --ffmpeg_dir=$INSTALL_FOLDER/ffmpeg_/bin/ \$@ > \$LOG_FILE 2>&1
