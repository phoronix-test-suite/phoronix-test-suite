...
LD_PRELOAD=../lib/libvpx.so  ./vpxenc --codec=vp9 -v --threads=\$THREADCOUNT --tile-columns=4 -o /dev/null ~/Jockey_1920x1080_120fps_420_8bit_YUV.y4m --width=1920 --height=1080 2> \$LOG_FILE 
