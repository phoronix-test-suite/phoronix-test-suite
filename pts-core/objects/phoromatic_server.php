...
class phoromatic_server
{
	...
	public static function prepare_database()
	{
		...
		if(self::read_database_version() == 0)
		{
			...
			self::$db->exec('CREATE TABLE phoromatic_schedules_triggers (AccountID TEXT UNIQUE, ScheduleID INTEGER UNIQUE, Trigger TEXT UNIQUE, TriggerTarget TEXT, TriggeredOn TEXT)');
			...
			self::$db->exec('CREATE TABLE phoromatic_systems (AccountID TEXT UNIQUE, SystemID TEXT UNIQUE, Title TEXT, Description TEXT, Groups TEXT, Hardware TEXT, Software TEXT, ClientVersion TEXT, GSID TEXT, CurrentTask TEXT, EstimatedTimeForTask TEXT, CreatedOn TEXT, LastCommunication TEXT, LastIP TEXT, State INTEGER, LocalIP TEXT, Flags TEXT)');
