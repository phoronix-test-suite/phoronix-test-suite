...
class pts_OverviewGraph extends pts_Graph
{
	...
	public function renderGraph()
	{
		...
		foreach($this->result_file->get_result_objects() as $i => $result_object)
		{
			...
			$this->graph_image->write_text_center($result_object->test_result->test_profile->get_test_title(), $this->graph_font, $this->graph_font_size_identifiers, $this->graph_color_headers, $px_bound_left, $top_end + 5, $px_bound_right, $top_end + 5, false);
