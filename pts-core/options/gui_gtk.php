...
class gui_gtk implements pts_option_interface
{
	...
	public static function show_preferences_interface()
	{
		...
		// User Settings
		P_OPTION_USAGE_REPORTING, P_OPTION_LOAD_MODULES, P_OPTION_DEFAULT_BROWSER, P_OPTION_PHODEVI_CACHE, P_OPTION_DISPLAY_MODE, 
		...
		P_OPTION_BATCH_PROMPTIDENTIFIER, P_OPTION_BATCH_PROMPTDESCRIPTION, P_OPTION_BATCH_PROMPTSAVENAME, P_OPTION_BATCH_TESTALLOPTIONS, 
		// Graph Settings
