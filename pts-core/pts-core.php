...
function pts_define_directories()
{
	...
	pts_define('PTS_IS_DAEMONIZED_SERVER_PROCESS', PTS_IS_CLIENT && (pts_client::user_home_directory() == '/' || getenv('PTS_SERVER_PROCESS') == 1) && is_writable('/') ? true : false);
...
pts_define('PTS_VERSION', '5.4.0m4');
pts_define('PTS_CORE_VERSION', 5341);
