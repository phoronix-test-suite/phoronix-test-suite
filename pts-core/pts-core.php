...
function pts_define_directories()
{
	...
	pts_define('PTS_IS_DAEMONIZED_SERVER_PROCESS', PTS_IS_CLIENT && is_dir('/var/lib/') && is_writable('/') && !isset(getenv('USE_HOME_DIR')) ? true : false);
...
pts_define('PTS_VERSION', '6.4.0m0');
pts_define('PTS_CORE_VERSION', 6301);
