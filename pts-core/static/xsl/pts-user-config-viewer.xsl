...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="width: 90%; margin: 20px auto 10px; text-align: left;">
			...
			<h3>ReferenceSystems: <span style="color: #CC0000;"><xsl:value-of select="PhoronixTestSuite/Options/General/ReferenceSystems" /></span></h3>
			<p>The Phoronix Test Suite has support for a feature called &quot;reference system comparisons&quot; that allow the user to more easily compare their test results against a set of known test results on Phoronix Global. There are a set of reference system results included by default with each Phoronix Test Suite release, but if there are any extra or third-party reference systems you wish to use for easy comparison purposes, add their Phoronix Global IDs to this tag. Multiple Phoronix Global IDs should be delimited by a space.</p>
