...
class phoromatic_main implements pts_webui_interface
{
	...
	public static function render_page_process($PATH)
	{
		...
		$main = '<h2 style="color: #cdcdcd;">This is the next-generation Phoromatic that is under active development in Phoronix Test Suite 5.4. Please keep up with the latest Git activity via <a href="https://www.github.com/phoronix-test-suite/phoronix-test-suite">GitHub</a>. All key functionality should be implemented and is production-ready while other features and improvements are still forthcoming. Your code contributions and any feedback are welcome via our GitHub. We also accept <a href="http://www.phoronix-test-suite.com/?k=commercial">custom engineering work / commercial sponsorship</a> and other forms of support to continue its public, open-source development.</h2><hr />';
