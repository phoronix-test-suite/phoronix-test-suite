...
class phoromatic_maind implements pts_webui_interface
{
	...
	public static function render_page_process($PATH)
	{
		...
		$main .= '<div id="phoromatic_main_table_cell">
			<h2>' . count($systems_running_tests) . ' Systems Running Tests</h2>
			<h2>' . count($systems_idling) . ' Systems Idling Or Shutdown</h2>
			<h2>' . count($systems_needing_attention) . ' Systems Needing Attention</h2>
			<hr />
			</div>';
		...
		$main .= '<div id="phoromatic_main_table_cell">
		<h2>' . count($schedules_today) . ' Schedules Active Today</h2>
		<h2>' . count($schedules_total) . ' Schedules In Total</h2>
		<h2>' . count($benchmark_tickets_today) . ' Active Benchmark Tickets</h2>';
		...
		$main .= '<div id="phoromatic_main_table_cell">
		<h2>' . count($results_today) . ' Test Results Today</h2>
		<h2>' . count($results_this_week) . ' Test Results This Week</h2>
		<h2>' . count($results_total) . ' Test Results Total</h2>
		<hr />
		</div>';
		$main .= '</div>';
