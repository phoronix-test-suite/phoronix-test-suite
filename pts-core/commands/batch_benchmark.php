...
class batch_benchmark implements pts_option_interface
{
	...
	const doc_description = 'This option and its arguments are equivalent to the benchmark option, but the process will be run in the Phoronix Test Suite batch mode.';
